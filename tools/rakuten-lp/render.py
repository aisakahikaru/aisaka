...
<a class="site-logo" href="{root}index.html"><span class="site-logo-mark" aria-hidden="true">{e(ctx.get('logo', 'S'))}</span>{e(ctx['site_name'])}</a>
...
<p class="site-logo"><span class="site-logo-mark" aria-hidden="true">{e(ctx.get('logo', 'S'))}</span>{e(ctx['site_name'])}</p>
